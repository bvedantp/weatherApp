...
var timezoneDisplay = document.getElementsByClassName('time-zone')[0];
var tempDisplay = document.getElementsByClassName('temp')[0];
var weatherDisplay = document.getElementsByClassName('weather')[0];
var cityInput = document.getElementById('search');
var citySearchButton = document.getElementById('searchStart');
var getLocation = document.getElementById('current-loc');
var cityNameDisplay = document.getElementById('city-name');

function returnWeather(_x, _x2) {
  return _returnWeather.apply(this, arguments);
}

function _returnWeather() {
  _returnWeather = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(location, units) {
    var response, locInfo, datum;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("https://api.openweathermap.org/data/2.5/weather?q=".concat(location, "&units=").concat(units, "&appid=b3549bd3f6f519902ae3c5a9ed9abdf2"), {
              mode: 'cors'
            });
          ...
          case 5:
            locInfo = _context.sent;
            // eslint-disable-next-line no-unused-vars
            datum = returnData(locInfo);
            console.log(datum);
...
function _fetchLocation() {
  _fetchLocation = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee2() {
    var response, currLoc;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch("https://ipgeolocation.abstractapi.com/v1/?api_key=9fe767eb4c964332ba2841faa0d8f400");
          ...
          case 5:
            currLoc = _context2.sent;
            console.log(currLoc.city);
            return _context2.abrupt("return", currLoc.city);
...
getLocation.addEventListener('click', function () {
  // fetchLocation();
  onFirstLoad()["catch"](function (err) {
    alert("IT NO WORK!!!");
  });
});

function convertTime(offvalue) {
  // to convert time offset value to understandable date/time
  var currTime = new Date();
  var localTime = currTime.getTime();
  var localOffset = currTime.getTimezoneOffset() * 60000;
  var utc = localTime + localOffset;
  var currCityTime = utc + 1000 * "".concat(offvalue);
  var nd = new Date(currCityTime);
  return nd;
}

function returnData(information) {
  var temperature = information.main.temp;
  var tempMax = information.main.temp_max;
  var tempMin = information.main.temp_min;
  var humiditi = information.main.humidity;
  var cityName = information.name;
  var weatherType = information.weather[0].main;
  var weatherDesc = information.weather[0].description;
  var windSpeed = information.wind.speed;
  var timeZone = convertTime(information.timezone);
  return {
...
citySearchButton.addEventListener('click', function () {
  ...
  var value = cityInput.value; // returnWeather(`${value}`, 'metric');

  initLoad(value)["catch"](function (err) {
    alert("IT NO WORK!!!");
  });
});

function initLoad(_x3) {
  return _initLoad.apply(this, arguments);
}

function _initLoad() {
  _initLoad = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee3(value) {
    var datum, displayTime, timetime, timeZoneBefore, timeZoneAfter, tempMaxDisplay, tempMinDisplay, weatherTypeDisplay;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return returnWeather("".concat(value), 'metric');

          case 2:
            datum = _context3.sent;
            displayTime = "".concat(datum.timeZone);
            timetime = displayTime.split(' ');
            timeZoneBefore = document.createElement('div');
            timeZoneAfter = document.createElement('div');
            tempMaxDisplay = document.createElement('div');
            tempMinDisplay = document.createElement('div');
            weatherTypeDisplay = document.createElement('div');
            timeZoneBefore.textContent = "".concat(timetime[0]);
            timezoneDisplay.textContent = "".concat(timetime[1], " ").concat(timetime[2], " ").concat(timetime[3]);
            timeZoneAfter.textContent = "".concat(timetime[4]);
            tempDisplay.textContent = "Temp: ".concat(datum.temperature);
            tempMaxDisplay.textContent = "Max: ".concat(datum.tempMax);
            tempMinDisplay.textContent = "Min: ".concat(datum.tempMin);
            weatherDisplay.textContent = "".concat(datum.weatherType);
            weatherTypeDisplay.textContent = "".concat(datum.weatherDesc);
            cityNameDisplay.textContent = "".concat(datum.cityName);
...
function onFirstLoad() {
  return _onFirstLoad.apply(this, arguments);
}

function _onFirstLoad() {
  _onFirstLoad = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee4() {
    var value;
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! images/weatherReport.png */ "./src/images/weatherReport.png"), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  box-sizing: border-box;\n  color: black;\n  display: flex;\n  flex-direction: column;\n  font-family: Arial, Helvetica, sans-serif;\n  padding: 8px;\n}\n\n.timeContainer {\n  align-items: center;\n  display: flex;\n  flex-direction: column;\n  font-size: 20px;\n}\n\n.time-zone > div {\n  font-size: small;\n}\n\n.midContainer {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-around;\n  align-items: center;\n  gap: 10px;\n}\n\n.temp {\n  font-size: large;\n}\n\n.weather {\n  font-size: large;\n}\n\n.searchContainer {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n}\n\n.imgContainer {\n  max-height: 700px;\n  height: 500px;\n  width: 500px;\n}\n\n#weatherBoy {\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n  position: relative;\n  width: 100%;\n  height: 100%;\n  background-repeat: no-repeat;\n  background-size: contain;\n  object-fit: cover;\n}\n\n#city-name {\n  position: absolute;\n  top: 2px;\n  left: 2px;\n}", "",{"version":3,"sources":["webpack://./src/style.scss"],"names":[],"mappings":"AAAA;EACI,sBAAA;EACA,YAAA;EACA,aAAA;EACA,sBAAA;EACA,yCAAA;EACA,YAAA;AACJ;;AAEA;EACI,mBAAA;EACA,aAAA;EACA,sBAAA;EACA,eAAA;AACJ;;AAEA;EACI,gBAAA;AACJ;;AAEA;EACI,aAAA;EACA,mBAAA;EACA,6BAAA;EACA,mBAAA;EACA,SAAA;AACJ;;AAGA;EACI,gBAAA;AAAJ;;AAGA;EACI,gBAAA;AAAJ;;AAGA;EACI,aAAA;EACA,mBAAA;EACA,uBAAA;AAAJ;;AAGA;EACI,iBAAA;EACA,aAAA;EACA,YAAA;AAAJ;;AAGA;EACI,yDAAA;EACA,kBAAA;EACA,WAAA;EACA,YAAA;EACA,4BAAA;EACA,wBAAA;EACA,iBAAA;AAAJ;;AAGA;EACI,kBAAA;EACA,QAAA;EACA,SAAA;AAAJ","sourcesContent":["body {\n    box-sizing: border-box;\n    color: black;\n    display: flex;\n    flex-direction: column;\n    font-family: Arial, Helvetica, sans-serif;\n    padding: 8px;\n}\n\n.timeContainer {\n    align-items: center;\n    display: flex;\n    flex-direction: column;\n    font-size: 20px;\n}\n\n.time-zone > div {\n    font-size: small;\n}\n\n.midContainer {\n    display: flex;\n    flex-direction: row;\n    justify-content: space-around;\n    align-items: center;\n    gap: 10px;\n\n}\n\n.temp {\n    font-size: large;\n}\n\n.weather {\n    font-size: large;\n}\n\n.searchContainer {\n    display: flex;\n    flex-direction: row;\n    justify-content: center;\n}\n\n.imgContainer {\n    max-height: 700px;\n    height: 500px;\n    width: 500px;\n}\n\n#weatherBoy {\n    background-image: url(images/weatherReport.png);\n    position: relative;\n    width: 100%;\n    height: 100%;\n    background-repeat: no-repeat;\n    background-size: contain;\n    object-fit: cover;\n}\n\n#city-name {\n    position: absolute;\n    top: 2px;\n    left: 2px;\n}"],"sourceRoot":""}]);
// Exports
...
"use strict";
module.exports = __webpack_require__.p + "fb2887b9d18afddf2e28.png";
